let Showoooo = document.getElementById("Showoooo");
let searchhh= document.getElementById("search_data");
let Permissible;
let Name_Inp = false;
let Email_Inp = false;
let Phone_Inp = false;
...
let Repassword_Inp = false;
     ...
     function Mealss(pramtar) {
        ...
        Showoooo.innerHTML = hasalaah
    }
    
    
     async function Get_Cat() {
        Showoooo.innerHTML = ""
        $(".inner-Loadsp").fadeIn(300)
     ...
     async function Get_CatMeals(pramtar) {
        ...
        Mealss(response.meals.slice(0, 20))
        $(".inner-Loadsp").fadeOut(300)
     ...
     async function SearchNa(term) {
        ...
        response.meals ? Mealss(response.meals) : Mealss([])
        $(".inner-Loadsp").fadeOut(300)
     ...
     function showContacts() {
        Showoooo.innerHTML = `<div class="contact min-vh-100 d-flex justify-content-center align-items-center">
        <div class="container w-75 text-center">
            ...
            <button id="Permissible" disabled class="btn btn-outline-danger px-2 mt-3">Submit</button>
        </div>
    </div> `
    Permissible = document.getElementById("Permissible")
     ...
     function inputsValidation() {
        ...
        if (Name_Rgex() && Email_Rgex() && Phone_Rgex() && Age_Rgex() && Password_Rgex() && RePassword_Rgex())
         {
            Permissible.removeAttribute("disabled")
            Permissible.addEventListener("click",function k(){
                clear()
            })
         } 
         else {
            Permissible.setAttribute("disabled", true )
        }
    ...
    function clear(){
        ...
        let p= document.getElementById("phoneInput")
        let a= document.getElementById("ageInput")
        let sw= document.getElementById("passwordInput")
        let rw= document.getElementById("repasswordInput")
